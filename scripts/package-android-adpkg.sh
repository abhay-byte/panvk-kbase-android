#!/bin/sh
# package-android-adpkg.sh — Android flat ZIP + provenance
# Usage: ./scripts/package-android-adpkg.sh --profile g615-v11-csf --version v0.1.0-beta.2
...
MATRIX=""
for c in \
  "$ROOT/dist/android-$PROFILE/runtime-feature-matrix.json" \
