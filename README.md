...
Full specification in [`docs/RUNTIME-FEATURES.md`](docs/RUNTIME-FEATURES.md).

- **Vulkan API Version**: `1.4.363`
- **Total Extensions Exposed**: `168` (8 Instance, 160 Device)
